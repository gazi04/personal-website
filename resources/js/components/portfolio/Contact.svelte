...
<section class="py-24 bg-[#f8f9fa]" id="contact">
    <div class="max-w-[1100px] mx-auto px-8">
        <p
            class="flex items-center gap-3 font-['JetBrains_Mono'] text-xs text-[#94a3b8] uppercase tracking-[0.15em] mb-4"
        >
            06 / Contact
        </p>
        <h2
            class="font-['DM_Sans'] font-extrabold text-[#0f172a] mb-12 text-[clamp(2rem,5vw,3rem)]"
        >
            Let's Build Something
        </h2>

        <div
            class="grid grid-cols-[1fr_1.4fr] max-md:grid-cols-1 gap-20 max-md:gap-12 items-start"
        >
            <div>
                <p
                    class="font-['Inter'] text-base text-[#334155] leading-[1.8] mb-8"
                >
                    Whether you have a system that needs to scale, an
                    architecture that needs rethinking, or you just want to talk
                    backend — I'm listening.
                </p>
                ...
                <div class="flex flex-col gap-3 mb-8">
                    ...
                    >
                        <span
                            class="font-['JetBrains_Mono'] text-[0.8rem] w-6 text-[#94a3b8]"
                            >✉</span
                        >
                ...
                {#if person.available}
                    <div
                        class="flex items-center gap-4 px-5 py-4 bg-white border border-[#e2e8f0] rounded-xl shadow-sm"
                    >
                        <span
                            class="w-2 h-2 rounded-full bg-[#334155] shrink-0 animate-pulse"
                        ></span>
                        <div>
                            <p
                                class="font-['JetBrains_Mono'] text-[0.8rem] text-[#0f172a]"
                            >
                                Currently available
                            </p>
                            <p
                                class="font-['Inter'] text-[0.8rem] text-[#94a3b8]"
                            >
            ...
            >
                {#if status === 'sent'}
                    <div
                        class="flex flex-col gap-2 p-8 bg-white border border-[#e2e8f0] rounded-xl shadow-sm"
                    >
                        <p
                            class="font-['DM_Sans'] text-xl font-bold text-[#0f172a]"
                        >
                            Message received.
                        </p>
                        <p class="font-['Inter'] text-[0.9rem] text-[#64748b]">
                ...
                {:else}
                    <div class="grid grid-cols-2 max-sm:grid-cols-1 gap-4">
                        <div class="flex flex-col gap-1.5">
                            <label
                                for="name"
                                class="font-['JetBrains_Mono'] text-[0.72rem] text-[#94a3b8] uppercase tracking-[0.08em]"
                                >Name</label
                            >
                            <input
                                id="name"
